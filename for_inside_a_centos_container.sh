...
# policy utils support (for SELinux-related operations)
...
# SELinux context setup (optional, useful in a container with SELinux enabled)
echo "=== Applying SELinux context for writable DB === "
semanage fcontext -a -t httpd_sys_rw_content_t "/var/www/html(/.*)?"
restorecon -Rv /var/www/html

# Enable SELinux if necessary (for Docker)
